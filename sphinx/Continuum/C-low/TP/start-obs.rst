...
#. Insert the Local Oscillator (LO) value in MHz
...
#. Insert the bandwidth (300, 730, 1250 or 2000 MHz) and choose the sample rate (in MHz). Note that in order to have a clean band with the C-low using the TP, we recommend to use LO=4600 MHz and a bandwidth of 300 MHz.
